        ...
        <div className="w-full min-h-screen flex items-center justify-center flex-col lg:flex-row bg-[#f3f4f6]">
            <div className="w-full md:w-auto flex gap-0 md:gap-40 flex-col md:flex-row items-center justify-center">
                ...
                <div className="h-full w-full lg:w-2/3 flex items-center justify-center">
                    <div className="w-full md:w-lg 2xl:max-w-3xl flex flex-col items-center justify-center gap-5 md:gap-10 2xl:mt-20" >
                ...
                <div className="w-full md:w-1/3 p-4 md:p-1 flex flex-col justify-center items-center">
                    <form onSubmit={handleSubmit(submitHandler)} className="form-container w-full md:w-[400px] flex flex-col gap-y-8 bg-white px-10 py-14 rounded-xl shadow-2xl">
                        <div>
