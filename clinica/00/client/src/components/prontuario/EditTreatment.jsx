    ...
    useEffect(() => {
        if (initialItem) {
            reset({
                ...
                profissional: initialItem.profissional
            });
        } else {
            reset({ date: new Date().toISOString().split('T')[0], procedure: "", notes: "", profissional: "" });
        }
            ...
            <div className='w-full'>
                ...
                <form onSubmit={handleSubmit(handleFormSubmit)} className="flex flex-col gap-4">
                    ...
                    <Textbox
                        ...
                        label='Profissional'
                        className='w-full rounded'
                        register={register("profissional", { required: "Profissional name is required" })}
                        error={errors.profissional ? errors.profissional.message : ""}
                    />
